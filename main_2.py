...
if __name__ == '__main__':
    keywords = ['Google', 'COVID', 'WebDriver']
    ...
    def get_post(urls):
        ...
        result = BeautifulSoup(ret.text, 'html.parser')
        return result
    ...
    for article in articles:
        ...
        soup_post = get_post(url_post + href)
        text_posts = soup_post.find(class_='tm-article-body')
        for keyword in keywords:
            if keyword in text_posts.text.split():
